...
import KitchenLocationPreview from '../../components/location/KitchenLocationPreview'
  ...
  return (
    <section className="card dashboard-section" aria-labelledby="kitchen-profile-heading">
      ...
      <section className="kitchen-location" aria-labelledby="kitchen-location-heading">
        ...
        <KitchenLocationPreview area={kitchen.area} precision={kitchen.locationPrecision} zipCode={kitchen.zipCode} />
      </section>
    </section>
  )
}
